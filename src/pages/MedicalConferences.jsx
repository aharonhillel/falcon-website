        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Falcon Events Limited is established as the unique destination for medical event management. With unmatched expertise in the clinical community across Asia and globally, we deliver exceptional conferences, symposiums, and training events that advance medical education and foster professional collaboration.
            </p>
